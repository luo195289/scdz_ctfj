...
document.ready(function () {
  ...
  //---------医生
	  ...
	  _('.ys_c_c_l_t_x_c').events('touchmove',function () {
		  this.style.background = this.style.backgroundX;
	  });
	  ...
	  _('.ys_c_c_l_c_c_c').events('touchmove',function () {
		  this.style.boxShadow = this.style.boxShadowX;
	  });
  //---------费用
  ...
  //---------导航
	  ...
	  _('.dh_c_c_l_a_c_go').events('touchmove',function () {
		  this.style.border = this.style.borderX;
		  this.style.backgroundColor = this.style.backgroundColorX;
	  });
	  _('.dh_c_c_l_a_c_b').events('click',function () {
		  ...
		  if (a == 0) {
			  _('.dh_c_c_l_b_c_x_x1').css({'left':'179px'});
		  } else if (a == 1) {
			  _('.dh_c_c_l_b_c_x_x1').css({'left':'399px'});
		  }
	  });
  //---------帮助
	  ...
	  _('.bz_c_c_b_c_xj').events('touchmove',function () {
		  this.style.boxShadow = this.style.boxShadowX;
	  });
  //---------投诉
  ...
  //###################### 接口调用 ########################
	...
	requestAnimationFrame(cost_details_1280_800);
